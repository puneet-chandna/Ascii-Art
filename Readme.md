# 💀THE MOST INSANE ASCII VIDEO CONVERTER EVER CREATED 💀
...
#### 💀 **ULTRA INSANE MODE**
- Resolution so high, NASA called asking for their pixels back
- Colors so vibrant, your terminal will need therapy
- FPS so smooth, butter gets jealous

#### 🌈 **RAINBOW VOMIT MODE** 
- 24-bit TRUE COLOR ASCII
- Your GPU will cry
- Epilepsy warning should be a feature

#### 📺 **AUTO-TERMINAL DETECTION**
- Fills your ENTIRE terminal
- Knows your screen better than you do
- Probably watching you right now 👁️

#### 🎮 **INTERACTIVE MENU FROM HELL**
```
┌─────────────────────────┐
│ Choose Your Destruction │
├─────────────────────────┤
│ 1. MELT YOUR CPU       │
│ 2. DESTROY YOUR RETINA │
